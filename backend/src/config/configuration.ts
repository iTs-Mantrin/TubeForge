export default () => ({
  ...
  ytDlp: {
    ...
    concurrentFragments: parseInt(process.env.YT_DLP_CONCURRENT_FRAGMENTS || '8', 10),
    throttledRate: process.env.YT_DLP_THROTTLED_RATE || '100K',
    limitRate: process.env.YT_DLP_LIMIT_RATE || '50M',
    retries: process.env.YT_DLP_RETRIES || '10',
    fragmentRetries: process.env.YT_DLP_FRAGMENT_RETRIES || '10',
    socketTimeout: parseInt(process.env.YT_DLP_SOCKET_TIMEOUT || '30', 10),
